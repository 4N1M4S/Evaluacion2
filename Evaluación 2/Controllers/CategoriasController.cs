...
namespace Evaluación_2.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(Evaluación_2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          ...
                          Problem("Entity set 'Evaluación_2Context.Categoria'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Evaluación_2Context.Categoria'  is null.");
            }
            var categoria = await _context.Categoria.FindAsync(id);
            if (categoria != null)
            {
